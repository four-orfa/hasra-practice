...
/** aggregated selection of "hobbies" */
export type Hobbies_Aggregate = {
  __typename?: 'hobbies_aggregate'
  aggregate?: Maybe<Hobbies_Aggregate_Fields>
  nodes: Array<Hobbies>
}

/** aggregate fields of "hobbies" */
export type Hobbies_Aggregate_Fields = {
  __typename?: 'hobbies_aggregate_fields'
  count: Scalars['Int']
  max?: Maybe<Hobbies_Max_Fields>
  min?: Maybe<Hobbies_Min_Fields>
}

/** aggregate fields of "hobbies" */
export type Hobbies_Aggregate_FieldsCountArgs = {
  columns?: InputMaybe<Array<Hobbies_Select_Column>>
  distinct?: InputMaybe<Scalars['Boolean']>
}

/** Boolean expression to filter rows from the table "hobbies". All fields are combined with a logical 'AND'. */
export type Hobbies_Bool_Exp = {
  _and?: InputMaybe<Array<Hobbies_Bool_Exp>>
  _not?: InputMaybe<Hobbies_Bool_Exp>
  _or?: InputMaybe<Array<Hobbies_Bool_Exp>>
  hobby?: InputMaybe<String_Comparison_Exp>
  id?: InputMaybe<Uuid_Comparison_Exp>
}

/** unique or primary key constraints on table "hobbies" */
export enum Hobbies_Constraint {
  /** unique or primary key constraint */
  HobbiesPkey = 'hobbies_pkey',
}

/** input type for inserting data into table "hobbies" */
export type Hobbies_Insert_Input = {
  hobby?: InputMaybe<Scalars['String']>
  id?: InputMaybe<Scalars['uuid']>
}

/** aggregate max on columns */
export type Hobbies_Max_Fields = {
  __typename?: 'hobbies_max_fields'
  hobby?: Maybe<Scalars['String']>
  id?: Maybe<Scalars['uuid']>
}

/** aggregate min on columns */
export type Hobbies_Min_Fields = {
  __typename?: 'hobbies_min_fields'
  hobby?: Maybe<Scalars['String']>
  id?: Maybe<Scalars['uuid']>
}

/** response of any mutation on the table "hobbies" */
export type Hobbies_Mutation_Response = {
  __typename?: 'hobbies_mutation_response'
  /** number of rows affected by the mutation */
  affected_rows: Scalars['Int']
  /** data from the rows affected by the mutation */
  returning: Array<Hobbies>
}

/** on_conflict condition type for table "hobbies" */
export type Hobbies_On_Conflict = {
  constraint: Hobbies_Constraint
  update_columns?: Array<Hobbies_Update_Column>
  where?: InputMaybe<Hobbies_Bool_Exp>
}

/** Ordering options when selecting data from "hobbies". */
export type Hobbies_Order_By = {
  hobby?: InputMaybe<Order_By>
  id?: InputMaybe<Order_By>
}

/** primary key columns input for table: hobbies */
export type Hobbies_Pk_Columns_Input = {
  id: Scalars['uuid']
}

/** select columns of table "hobbies" */
export enum Hobbies_Select_Column {
  /** column name */
  Hobby = 'hobby',
  /** column name */
  Id = 'id',
...
/** input type for updating data in table "hobbies" */
export type Hobbies_Set_Input = {
  hobby?: InputMaybe<Scalars['String']>
  id?: InputMaybe<Scalars['uuid']>
}

/** update columns of table "hobbies" */
export enum Hobbies_Update_Column {
  /** column name */
  Hobby = 'hobby',
  /** column name */
  Id = 'id',
...
export type Mutation_Root = {
  ...
  /** delete data from the table: "hobbies" */
  delete_hobbies?: Maybe<Hobbies_Mutation_Response>
  /** delete single row from the table: "hobbies" */
  delete_hobbies_by_pk?: Maybe<Hobbies>
  ...
  /** insert data into the table: "hobbies" */
  insert_hobbies?: Maybe<Hobbies_Mutation_Response>
  /** insert a single row into the table: "hobbies" */
  insert_hobbies_one?: Maybe<Hobbies>
  ...
  /** update data of the table: "hobbies" */
  update_hobbies?: Maybe<Hobbies_Mutation_Response>
  /** update single row of the table: "hobbies" */
  update_hobbies_by_pk?: Maybe<Hobbies>
...
/** mutation root */
export type Mutation_RootDelete_HobbiesArgs = {
  where: Hobbies_Bool_Exp
}

/** mutation root */
export type Mutation_RootDelete_Hobbies_By_PkArgs = {
  id: Scalars['uuid']
}
...
/** mutation root */
export type Mutation_RootInsert_HobbiesArgs = {
  objects: Array<Hobbies_Insert_Input>
  on_conflict?: InputMaybe<Hobbies_On_Conflict>
}

/** mutation root */
export type Mutation_RootInsert_Hobbies_OneArgs = {
  object: Hobbies_Insert_Input
  on_conflict?: InputMaybe<Hobbies_On_Conflict>
}
...
/** mutation root */
export type Mutation_RootUpdate_HobbiesArgs = {
  _set?: InputMaybe<Hobbies_Set_Input>
  where: Hobbies_Bool_Exp
}

/** mutation root */
export type Mutation_RootUpdate_Hobbies_By_PkArgs = {
  _set?: InputMaybe<Hobbies_Set_Input>
  pk_columns: Hobbies_Pk_Columns_Input
}
...
export type Query_Root = {
  ...
  /** fetch data from the table: "hobbies" */
  hobbies: Array<Hobbies>
  /** fetch aggregated fields from the table: "hobbies" */
  hobbies_aggregate: Hobbies_Aggregate
  /** fetch data from the table: "hobbies" using primary key columns */
  hobbies_by_pk?: Maybe<Hobbies>
  /** An array relationship */
  profile_users: Array<Profile_Users>
  /** An aggregate relationship */
  profile_users_aggregate: Profile_Users_Aggregate
...
export type Query_RootHobbiesArgs = {
  distinct_on?: InputMaybe<Array<Hobbies_Select_Column>>
  limit?: InputMaybe<Scalars['Int']>
  offset?: InputMaybe<Scalars['Int']>
  order_by?: InputMaybe<Array<Hobbies_Order_By>>
  where?: InputMaybe<Hobbies_Bool_Exp>
}

export type Query_RootHobbies_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Hobbies_Select_Column>>
  limit?: InputMaybe<Scalars['Int']>
  offset?: InputMaybe<Scalars['Int']>
  order_by?: InputMaybe<Array<Hobbies_Order_By>>
...
export type Query_RootHobbies_By_PkArgs = {
  id: Scalars['uuid']
}
...
export type Subscription_RootHobbiesArgs = {
  distinct_on?: InputMaybe<Array<Hobbies_Select_Column>>
  limit?: InputMaybe<Scalars['Int']>
  offset?: InputMaybe<Scalars['Int']>
  order_by?: InputMaybe<Array<Hobbies_Order_By>>
...
export type Subscription_RootHobbies_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Hobbies_Select_Column>>
  limit?: InputMaybe<Scalars['Int']>
  offset?: InputMaybe<Scalars['Int']>
  order_by?: InputMaybe<Array<Hobbies_Order_By>>
...
export type Subscription_RootHobbies_By_PkArgs = {
  id: Scalars['uuid']
}
...
export type GetUsersQuery = {
  __typename?: 'query_root'
  users: Array<{ __typename?: 'users'; created_at: any; id: any; name: string }>
}
