...
const HasuraCRUD: FC = () => {
  ...
  if (error) {
    return <Layout title="Hasura CURD">Error: {error.message}</Layout>
  }

  return (
    <Layout title="Hasura CRUD">
      <span className="mb-3, font-bold">Hasura CRUD</span>
      <form
      ...
      >
        ...
        <button
          ...
          className="disabled:opacity-40 mt-3 py-1 px-3 text-white bg-indigo-600 hover:bg-indigo-700 rounded-2xl focus-outline-none"
          data-testid="new"
          type="submit"
        >
